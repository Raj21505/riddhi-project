(function () {
    ...
    function getAPIUrl() {
        const savedApiUrl = localStorage.getItem('SDSS_API_URL');
        if (savedApiUrl) {
    ...
    function buildWidget() {
        ...
        const onSend = async () => {
            ...
            try {
                ...
                completeTyping(`Connection error: ${error.message || error}. Make sure the backend is running and reachable from this page origin.`);
